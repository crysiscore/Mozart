...
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate varchar(5),key(person_id,encounter_id)) as SELECT 	o.person_id,
				e.encounter_id,
				case o.value_coded
					when 1065 then 'SIM'
					when 1066 then 'NAO'
...
UPDATE t_aconselhamento,t
set t_aconselhamento.criteriosmedicos=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;


drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate boolean,key(person_id,encounter_id)) as SELECT 	o.person_id,
				e.encounter_id,
				case o.value_coded
					when 1065 then true
...
UPDATE t_aconselhamento,t
set t_aconselhamento.conceitos=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
UPDATE t_aconselhamento,t
set t_aconselhamento.interessado=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
UPDATE t_aconselhamento,t
set t_aconselhamento.confidente=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
UPDATE t_aconselhamento,t
set t_aconselhamento.apareceregularmente=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
UPDATE t_aconselhamento,t
set t_aconselhamento.riscopobreaderencia=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
UPDATE t_aconselhamento,t
set t_aconselhamento.regimetratamento=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;


drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate boolean,datapronto datetime,key(person_id,encounter_id)) as SELECT 	o.person_id,
				e.encounter_id,
				case o.value_coded
					when 1065 then true
					when 1066 then false
...
UPDATE t_aconselhamento,t
set t_aconselhamento.prontotarv=t.fieldUpdate,
	t_aconselhamento.datapronto=t.datapronto
where t_aconselhamento.encounter_id=t.encounter_id;


drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate varchar(60),key(person_id,encounter_id)) as SELECT 	o.person_id,
				e.encounter_id,
...
UPDATE t_aconselhamento,t
set t_aconselhamento.obs=t.fieldUpdate
where t_aconselhamento.encounter_id=t.encounter_id;
...
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,idaconselhamento int(5),fieldupdate int(10),key(person_id,encounter_id,idaconselhamento)) as SELECT 	o.person_id,
			o.encounter_id,
			ta.idaconselhamento,
...
update t_actividadeaconselhamento,t
set t_actividadeaconselhamento.nrsessao=t.fieldUpdate
where t_actividadeaconselhamento.idaconselhamento=t.idaconselhamento;

drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,idaconselhamento int(5),fieldupdate varchar(45),key(person_id,encounter_id,idaconselhamento)) as SELECT 	o.person_id,
			o.encounter_id,
			ta.idaconselhamento,
			case o.value_coded
...
update t_actividadeaconselhamento,t
set t_actividadeaconselhamento.tipoactividade=t.fieldUpdate
where t_actividadeaconselhamento.idaconselhamento=t.idaconselhamento;

drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,idaconselhamento int(5),fieldupdate boolean,key(person_id,encounter_id,idaconselhamento)) as SELECT 	o.person_id,
			o.encounter_id,
			ta.idaconselhamento,
			case o.value_coded
				when 1065 then true
...
update t_actividadeaconselhamento,t
set t_actividadeaconselhamento.apresentouconfidente=t.fieldUpdate
where t_actividadeaconselhamento.idaconselhamento=t.idaconselhamento;
...
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,dataentregaactivista datetime,key(person_id,encounter_id,dataentregaactivista)) as SELECT 	o.person_id,e.encounter_id,o.value_datetime as dataentregaactivista
            FROM 	openmrs.encounter e
                	inner join openmrs.obs o on e.encounter_id=o.encounter_id and o.person_id=e.patient_id
            WHERE 	e.encounter_type=21 and o.concept_id=2173 and o.voided=0 and e.voided=0;
update t_buscaactiva,t
set 	t_buscaactiva.dataentregaactivista=t.dataentregaactivista
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*Actualizar Paciente localizado*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate datetime,fieldupdate1 varchar(10),key(person_id,encounter_id)) as SELECT 	o.person_id,e.encounter_id,
...
update t_buscaactiva,t
set 	t_buscaactiva.pacientelocalizado=t.fieldupdate1,
		t_buscaactiva.datalocalizacao=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*COD MOTIVO ABANDONO*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate varchar(45),key(person_id,encounter_id,fieldupdate)) as SELECT 	o.person_id,
					e.encounter_id,
					case o.value_coded
...
update t_buscaactiva,t
set 	t_buscaactiva.codmotivoabandono=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.codreferencia=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*CONVITE*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate1 varchar(10),fieldupdate datetime,key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
...
update t_buscaactiva,t
set 	t_buscaactiva.entregueconvite=t.fieldupdate1,
		t_buscaactiva.dataentregaconvite=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;

/*CONFIDENTE IDENTIFICADO*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate varchar(10),key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
					case o.value_coded
						when 1065 then 'SIM'
						when 1066 then 'NAO'
...
update t_buscaactiva,t
set 	t_buscaactiva.confidenteidentificado=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*INFORMACAO DADA POR*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate varchar(30),key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
					case o.value_coded
...
update t_buscaactiva,t
set 	t_buscaactiva.codinformacaodadapor=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.Codservicoquerefere=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;

/*Data Segunda Tentativa*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,fieldupdate datetime,key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
					o.value_datetime as fieldupdate
            FROM 	openmrs.encounter e
                	inner join openmrs.obs o on e.encounter_id=o.encounter_id and o.person_id=e.patient_id
...
update t_buscaactiva,t
set 	t_buscaactiva.datasegundatentativa=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.dataterceiratentativa=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.tipovisita=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.observacao=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*MOTIVO FALTA*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,esqueceudata boolean,estadecama boolean,
problemadetransporte boolean,faltaalimentacao boolean,mauatendimento boolean,
busca_efeitossecundarios boolean,tratamentotradicional boolean,desistiu boolean,key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
...
update t_buscaactiva,t
set 	t_buscaactiva.esqueceudata=t.esqueceudata,
		t_buscaactiva.estadecama=t.estadecama,
		t_buscaactiva.problemadetransporte=t.problemadetransporte,
		t_buscaactiva.faltaalimentacao=t.faltaalimentacao,
		t_buscaactiva.mauatendimento=t.mauatendimento,
		t_buscaactiva.busca_efeitossecundarios=t.busca_efeitossecundarios,
		t_buscaactiva.tratamentotradicional=t.tratamentotradicional,
		t_buscaactiva.desistiu=t.desistiu
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.outromotivo=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;


/*RELATORIO DE VISITA*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,estabem boolean,dificulades boolean,
dificuldadefamilia boolean,dificuldadeefeitossecundarios boolean,faltadeapoio boolean,
dificuldadetomamedicamento boolean,naoreveloudiagnostico boolean,key(person_id,encounter_id)) as SELECT 	o.person_id,
					e.encounter_id,
...
update t_buscaactiva,t
set 	t_buscaactiva.estabem=t.estabem,
		t_buscaactiva.dificulades=t.dificulades,
		t_buscaactiva.dificuldadefamilia=t.dificuldadefamilia,
		t_buscaactiva.dificuldadeefeitossecundarios=t.dificuldadeefeitossecundarios,
		t_buscaactiva.faltadeapoio=t.faltadeapoio,
		t_buscaactiva.dificuldadetomamedicamento=t.dificuldadetomamedicamento,
		t_buscaactiva.naoreveloudiagnostico=t.naoreveloudiagnostico
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
update t_buscaactiva,t
set 	t_buscaactiva.dataentregacartao=t.fieldupdate
where 	t_buscaactiva.encounter_id=t.encounter_id;
...
/*Atualizar medico*/
drop table if exists t;
create table t (nid varchar(45),encounter_datetime datetime ,medico int(11),key(nid,encounter_datetime,medico)) as SELECT	p.nid,e.encounter_datetime,ep.provider_id medico
FROM	t_paciente p
	inner join	openmrs.encounter e on p.patient_id=e.patient_id
...
UPDATE t_observacaopaciente,t
SET t_observacaopaciente.medico = t.medico
WHERE t_observacaopaciente.nid = t.nid;
...
drop table if exists t;
create table t(ultimo_regime varchar(45),encounter_id bigint primary key) as select case o.value_coded
...
update export_db.t_tarv,t
set		t_tarv.tipotarv=t.tipo
where	t_tarv.encounter_id=t.encounter_id;
...
/*REGIME*/
drop table if exists t;
create table t(encounter_id bigint primary key,ultimo_regime varchar(45)) as select e.encounter_id,
		case o.value_coded
...
update t_tarv,t set t_tarv.codregime=t.ultimo_regime
where t_tarv.encounter_id=t.encounter_id;

/*Data Proxima*/
drop table if exists t;
create table t(encounter_id bigint primary key,dataproxima datetime) as select	e.encounter_id,
...
update t_tarv, t set t_tarv.dataproxima=t.dataproxima
where t_tarv.encounter_id=t.encounter_id;

/*Quantidade Aviada*/
drop table if exists t;
create table t (encounter_id bigint ,qtdComp int(5),key(encounter_id,qtdComp)) as select distinct	e.encounter_id,
...
update t_tarv, t set t_tarv.QtdComp=t.qtdComp
where t_tarv.encounter_id=t.encounter_id ;

/*Quantidade Saldo*/
drop table if exists t;
create table t (encounter_id bigint ,qtdSaldo int(5),key(encounter_id,qtdSaldo)) as select distinct	e.encounter_id,
...
update t_tarv,t
set t_tarv.QtdSaldo=t.qtdSaldo
where t_tarv.encounter_id=t.encounter_id;

/*Dose*/
drop table if exists t;
create table t (encounter_id bigint ,dose varchar(30),key(encounter_id,dose)) as select distinct	e.encounter_id,o.value_text as dose
	from	openmrs.encounter e
			inner join openmrs.obs o on e.encounter_id=o.encounter_id
	where	e.voided=0 and o.voided=0 and e.encounter_type=18 and o.concept_id=1711 and e.encounter_datetime<=@dateFinal;
update t_tarv,t
set t_tarv.dose=t.dose
where t_tarv.encounter_id=t.encounter_id;
...
/*update NID*/
drop table if exists t;
create table t (patient_id int(10) ,nid varchar(30),key(patient_id,nid)) as select distinct patient_id,nid from export_db.t_paciente;
update t_tarv,t
set t_tarv.nid=t.nid
where t.patient_id=t_tarv.patient_id;

/*ACTUALIZAR COD MUDANCA*/
drop table if exists t;
create table t (codmudanca varchar(45),patient_id int(10),encounter_datetime datetime,key(codmudanca,patient_id,encounter_datetime)) as select case o.value_coded
...
update t_tarv,t
set		t_tarv.codmudanca=t.codmudanca
where	t_tarv.patient_id =t.patient_id and t_tarv.datatarv=t.encounter_datetime;

/*EFEITO SECUNDÀRIO*/
drop table if exists t;
create table t (efeito varchar(15),patient_id int(10),encounter_datetime datetime,key(efeito,patient_id,encounter_datetime)) as select case o.value_coded
				when 3 then 'A'
				when 6292 then 'N'
				when 6293 then 'P'
				when 6294 then 'H'
...
update t_tarv,t
set		t_tarv.efeitosSecundarios=t.efeito
where	t_tarv.patient_id=t.patient_id and t_tarv.datatarv=t.encounter_datetime;

/*MOTIVO INICIO*/
drop table if exists t;
create table t (criterio varchar(45),patient_id int(10),encounter_datetime datetime,key(criterio,patient_id,encounter_datetime)) as select case o.value_coded
...
update t_tarv,t
set		t_tarv.motivoInicioTarv=t.criterio
where	t_tarv.patient_id=t.patient_id and t_tarv.datatarv=t.encounter_datetime;

/*Actualizar idade*/
drop table if exists t;
create table t (patient_id int(10) ,datanasc datetime,key(patient_id,datanasc)) as select patient_id,datanasc from export_db.t_paciente;
update t_tarv,t
set t_tarv.idade=round(datediff(t_tarv.datatarv,t.datanasc)/365)
where t.patient_id=t_tarv.patient_id;

/*Inserir t_questionario*/
drop table if exists t;
create table t (person_id int(10),encounter_id bigint ,codopcao varchar(50),key(person_id,encounter_id,codopcao)) as SELECT 	o.person_id,e.encounter_id,
                  case o.value_coded
                  ...
                  else null end as codopcaoFillTarvTable
                FROM 	openmrs.encounter e
                      inner join openmrs.obs o on e.encounter_id=o.encounter_id
...
Select distinct t.codopcao, if(t.codopcao is not null,TRUE,FALSE) as estadoopcao,
              p.nid,
              e.encounter_datetime as data
      From t_paciente p inner join openmrs.encounter e on e.patient_id=p.patient_id
      inner join t on t.encounter_id=e.encounter_id
...
drop table if exists t;
create table t (patient_id int(10),data_abertura datetime ,tipopaciente varchar(45),location_id int(11),key(patient_id,data_abertura)) as Select 	p.patient_id,min(encounter_datetime) data_abertura,if(e.encounter_type=5,'Adulto','Crianca') tipopaciente,e.location_id
			from 	openmrs.patient p
					inner join openmrs.encounter e on e.patient_id=p.patient_id
			where 	p.voided=0 and e.encounter_type in (5,7) and e.voided=0 and e.encounter_datetime<=@dateFinal
			group by patient_id;

update 	export_db.t_paciente,t
set t_paciente.dataabertura=t.data_abertura,
	t_paciente.tipopaciente=t.tipopaciente,
	t_paciente.location_id=t.location_id
where t_paciente.patient_id=t.patient_id;
...
drop table if exists t;
create table t (patient_id int(10),codProv varchar(45),key(patient_id)) as Select 	p.patient_id,
				case o.value_coded
				when 1595 then 'ENF'
...
update t_paciente,t
set t_paciente.codproveniencia=t.codProv
where t.patient_id=t_paciente.patient_id;

/*Update LocalProveniencia*/
drop table if exists t;
create table t (patient_id int(10),value_text varchar(45),key(patient_id)) as Select 	p.patient_id,
					o.value_text
		from 	t_paciente p
				inner join openmrs.encounter e on e.patient_id=p.patient_id
				inner join openmrs.obs o on o.encounter_id=e.encounter_id
...
update t_paciente,t
set t_paciente.designacaoprov=t.value_text
where t.patient_id=t_paciente.patient_id;
...
update t_paciente,t
set t_paciente.codigoproveniencia=t.value_text
where t.patient_id=t_paciente.patient_id;
...
/*Inicio TARV*/
drop table if exists t;
create table t (patient_id int(10),data_inicio datetime,key(patient_id)) as select patient_id,min(data_inicio) data_inicio
		from
		(
			Select 	p.patient_id,min(e.encounter_datetime) data_inicio
			from 	openmrs.patient p
...
set t_paciente.emtarv=true,
	t_paciente.datainiciotarv=t.data_inicio
where t_paciente.patient_id=t.patient_id;
...
/*Estado Actual TARV*/
drop table if exists t;
create table t (patient_id int(10),start_date datetime,codeestado varchar(45),key(patient_id)) as select 	pg.patient_id,ps.start_date,
				case ps.state
					when 7 then 'TRANSFERIDO PARA'
...
update t_paciente,t
set 	t_paciente.codestado=t.codeestado,
		t_paciente.datasaidatarv=t.start_date
where t.patient_id=t_paciente.patient_id;
...
set 	t_paciente.codestado=t.codeestado,
		t_paciente.datasaidatarv=t.start_date
where t.patient_id=t_paciente.patient_id and t_paciente.datainiciotarv is null;
...
/*Data de Diagnostico*/
drop table if exists t;
create table t (patient_id int(10),value_datetime datetime,key(patient_id)) as Select 	p.patient_id,
				o.value_datetime
		from 	t_paciente p
				inner join openmrs.encounter e on p.patient_id=e.patient_id
				inner join openmrs.obs o on o.encounter_id=e.encounter_id
...
set 	t_paciente.datadiagnostico=t.value_datetime
where 	t_paciente.patient_id=t.patient_id;

/*Aconselhado*/
drop table if exists t;
create table t (patient_id int(10),key(patient_id)) as Select 	p.patient_id
		from 	t_paciente p
				inner join openmrs.encounter e on p.patient_id=e.patient_id
				inner join openmrs.obs o on o.encounter_id=e.encounter_id
		where 	e.voided=0 and o.voided=0 and
...
/*Update Regime*/
drop table if exists t;
create table t (patient_id int(10),ultimo_regime varchar(45),data_regime datetime,key(patient_id)) as select 	ultimo_lev.patient_id,
					case o.value_coded
						when 1651 then 'AZT+3TC+NVP'
						when 6324 then 'TDF+3TC+EFV'
						when 1703 then 'AZT+3TC+EFV'
			...
			where 	o.person_id=ultimo_lev.patient_id and o.obs_datetime=ultimo_lev.encounter_datetime and o.voided=0 and
					o.concept_id=1088;
update t_paciente,t
set		t_paciente.codregime=t.ultimo_regime
where	t_paciente.patient_id=t.patient_id;

/*Update Estadio OMS*/
drop table if exists t;
create table t (patient_id int(10),nome varchar(45),key(patient_id)) as select estadio1.patient_id,
...
set		t_paciente.estadiooms=t.nome
where	t_paciente.patient_id=t.patient_id;
...
drop table if exists t;
create table t (patient_id int(10),obs_datetime datetime,key(patient_id)) as Select 	p.patient_id,
				o.obs_datetime
		from 	t_paciente p
				inner join openmrs.encounter e on p.patient_id=e.patient_id
				inner join openmrs.obs o on o.encounter_id=e.encounter_id
...
set 	t_paciente.referidocd=true,
		t_paciente.DataCD=t.obs_datetime
where 	t_paciente.patient_id=t.patient_id;

/*EDUCAO e PREVENCAO*/
drop table if exists t;
create table t (patient_id int(10),obs_datetime datetime,valorEd varchar(5),key(patient_id)) as Select 	p.patient_id,
				o.obs_datetime,
...
/*APSS FORMA CONTACTO*/
drop table if exists t;
create table t (patient_id int(10),tipo varchar(50),key(patient_id)) as Select 	p.patient_id,
...
drop table if exists t;
create table t (nid varchar(45),datafim datetime,key(nid)) as SELECT 	p.nid,o.value_datetime as datafim
				FROM 	t_paciente p
						inner join openmrs.encounter e on p.patient_id=e.patient_id
						INNER JOIN openmrs.obs o ON e.encounter_id=o.encounter_id
				WHERE 	e.encounter_type IN (6,9) AND o.concept_id=6120 AND o.voided=0 AND e.voided=0 and e.encounter_datetime<=@dateFinal;
update t_tratamentotb,t
	set t_tratamentotb.datafim=t.datafim
	where t.nid=t_tratamentotb.nid;
...
begin
/*Added by Arnaldo*/
DECLARE total_rows int (10);
DECLARE i_row int(10);
/* --------------- */
...
/*Update Estadio OMS*/
drop table if exists t;
create table t(encounter_id bigint primary key,nome varchar(15)) as select ts.encounter_id,
				case o.value_coded
				when 1204 then 'I'
				when 1205 then 'II'
				when 1206 then 'III'
...
update t_seguimento,t
set		t_seguimento.estadiooms=t.nome
where	t_seguimento.encounter_id=t.encounter_id;


/*Update Data Proxima Consulta*/
drop table if exists t;
create table t(encounter_id int(10),value_datetime datetime, key(encounter_id,value_datetime) ) as Select distinct encounter_id,value_datetime from openmrs.obs where obs.concept_id=1410 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.dataproximaconsulta=t.value_datetime
where	t_seguimento.encounter_id=t.encounter_id ;

/*RASTREIO TB*/
drop table if exists t;
create table t(encounter_id int(10),value_coded int(5),key(encounter_id,value_coded) ) as Select distinct encounter_id,value_coded from openmrs.obs where obs.concept_id=6257 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.screeningtb=if(t.value_coded=1065,'SIM','NAO')
where	t_seguimento.encounter_id=t.encounter_id ;


/*RASTREIO ITS*/
drop table if exists t;
create table t(encounter_id int(10),value_coded int(5),key(encounter_id,value_coded) ) as Select distinct encounter_id,value_coded from openmrs.obs where obs.concept_id=6258 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.screeningIts=if(t.value_coded=1065,'SIM','NAO')
where	t_seguimento.encounter_id=t.encounter_id;

/*ACONSELHADO*/
drop table if exists t;
create table t(encounter_id int(10),value_coded int(5),key(encounter_id,value_coded) ) as Select distinct encounter_id,value_coded from openmrs.obs where obs.concept_id=1714 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.aconselhado=if(t.value_coded=1065,'SIM','NAO')
where	t_seguimento.encounter_id=t.encounter_id;


/*REFERIDO SECTOR CLINICO*/
drop table if exists t;
create table t(encounter_id bigint primary key,nome varchar(45)) as select ts.encounter_id,
				case o.value_coded
...
update t_seguimento,t
set		t_seguimento.referidoSectorClinico=t.nome
where	t_seguimento.encounter_id=t.encounter_id;

/*DUM*/
drop table if exists t;
create table t(encounter_id int(10),value_datetime datetime, key(encounter_id,value_datetime) ) as Select distinct encounter_id,value_datetime from openmrs.obs where obs.concept_id=1465 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.dum=t.value_datetime
where	t_seguimento.encounter_id=t.encounter_id;

/*DPP*/
drop table if exists t;
create table t(encounter_id int(10),value_datetime datetime, key(encounter_id,value_datetime) ) as Select distinct encounter_id,value_datetime from openmrs.obs where obs.concept_id=1600 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.dpp=t.value_datetime
where	t_seguimento.encounter_id=t.encounter_id;

/*PTV TARV*/
drop table if exists t;
create table t(encounter_id int(10),value_coded int(5),key(encounter_id,value_coded) ) as Select distinct encounter_id,value_coded from openmrs.obs where obs.concept_id=6286 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.PTV_TARV=if(t.value_coded=1598,'PTV','TARV')
where	t_seguimento.encounter_id=t.encounter_id;


/*LACTANTE*/
drop table if exists t;
create table t(encounter_id int(10),value_coded int(5),key(encounter_id,value_coded) ) as Select distinct encounter_id,value_coded from openmrs.obs where obs.concept_id=6332 and obs.voided=0;

update t_seguimento,t
set		t_seguimento.lactante=if(t.value_coded=1065,1,0)
where	t_seguimento.encounter_id=t.encounter_id;
...
/* added by Arnaldo    */
drop table if exists t;
create table t as Select 	p.patient_id,
				p.nid,
				e.encounter_datetime,
				e.encounter_id
		from 	t_paciente p
...
/*------------------------------------*/
	 ...
	 IF seguimentosNaData>0 THEN
		...
		/*ACTIVIDADE PP*/
		drop table if exists t;
        create table t(nome varchar(45)) as Select 	case o.value_coded
		...
		update t_seguimento,t
		set t_seguimento.apssActividade=t.nome
		where t_seguimento.patient_id=patientId and t_seguimento.dataseguimento=encDate;

		/*TIPO VISITA PP*/
		drop table if exists t;
        create table t(nome varchar(15)) as Select 	case o.value_coded
		...
		update t_seguimento,t
		set t_seguimento.apssTipovisita=t.nome
		where t_seguimento.patient_id=patientId and t_seguimento.dataseguimento=encDate;
		...
		update t_seguimento,t
		set t_seguimento.apssAdesao=t.nome
		where t_seguimento.patient_id=patientId and t_seguimento.dataseguimento=encDate;

		/*DATA PROXIMA PP*/
		drop table if exists t;
        create table t(value_datetime datetime) as Select o.value_datetime
					from 	openmrs.obs o
					where 	o.voided=0 and o.encounter_id=encID and o.concept_id=6310;
		update t_seguimento,t
		set t_seguimento.apssproximavisita=t.value_datetime
		where t_seguimento.patient_id=patientId and t_seguimento.dataseguimento=encDate;
	...
	/* added by Arnaldo    */
	if i_row=total_rows then SET no_more_rows=1; end if;
/*----------------------------------------------------------*/
END WHILE cur_loop;
CLOSE cur_apss;
SET no_more_rows=0;
...
/*Update Idade*/
drop table if exists t;
create table t(patient_id int(10) primary key,datanasc datetime ) as Select patient_id,datanasc from t_paciente;
update t_seguimento,t
set t_seguimento.idade=round(datediff(t_seguimento.dataseguimento,t.datanasc)/365)
where t.patient_id=t_seguimento.patient_id;

drop table if exists t;
create table t(patient_id int(10) primary key,datanasc datetime ) as Select patient_id,datanasc from t_paciente;
update t_seguimento,t
set t_seguimento.meses=round(datediff(t_seguimento.dataseguimento,t.datanasc)/30)
where t.patient_id=t_seguimento.patient_id and t_seguimento.idade<=2;
...
drop table if exists t;
create table t(encounter_id int(10),value_datetime datetime, key(encounter_id,value_datetime) ) as Select distinct encounter_id,value_datetime from openmrs.obs where obs.concept_id=6246 and obs.voided=0;
update t_resultadoslaboratorio,t
set datapedido=value_datetime
where t_resultadoslaboratorio.encounter_id=t.encounter_id; /*and obs.concept_id=6246 and obs.voided=0;*/

/*ACTUALIZAR DATA PROXIMO CONTROLO CD4*/
drop table if exists t;
create table t(encounter_id int(10) ,value_datetime datetime, key(encounter_id,value_datetime) ) as Select distinct encounter_id,value_datetime from openmrs.obs where obs.concept_id=6249 and obs.voided=0;

update t_resultadoslaboratorio,t
set dataProximoControlCd4=value_datetime
where t_resultadoslaboratorio.encounter_id=t.encounter_id and codexame='CD4';
