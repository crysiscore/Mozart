...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_magoanine.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%goanine%';
...
-- set @sismaLocationID := 1110514;  -- cs_magoanine
set @openmrsID :=208;
