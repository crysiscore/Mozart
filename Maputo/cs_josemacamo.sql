...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_cs_josemacamo.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%macamo%';
...
-- set @ydata := '2021-06-20';
-- set @sismaLocationID := 1110206;  --  cs_jose macamo
set @openmrsID :=212;
...
-- select property,property_value,description,uuid from global_property where property ='default_location';
*/
...
CALL export_db.EXPORTDB('2021-12-20', 'Maputo'); 
