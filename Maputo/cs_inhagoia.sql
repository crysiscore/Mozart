...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_inhagoia.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%inha%';
