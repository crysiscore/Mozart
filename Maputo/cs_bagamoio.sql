...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_bagamoio.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%bagamo%';
*/
...
set @sismaLocationID := 1110507;  -- cs_bagamoio
