...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_magoanine_tendas.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%magoan%';
...
-- set @sismaLocationID := 1110511 ;  -- cs_magoanine_tendas
set @openmrsID :=212;
