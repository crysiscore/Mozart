...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_altomae.sql
...
use openmrs;
SELECT  location_id, UUID, NAME FROM location  WHERE NAME = (SELECT property_value FROM global_property	WHERE property='default_location'  );
...
-- set @sismaLocationID := 1110106;  -- cs_alto_mae
set @openmrsID :=212;
