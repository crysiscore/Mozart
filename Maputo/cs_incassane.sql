...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_incassane.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%ssane%';
...
-- set @sismaLocationID := 1110613;  -- cs_incassane
set @openmrsID :=212;
