...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_zimpeto.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%impeto%';
*/
...
-- set @sismaLocationID := 1110515;  -- cs_zimpeto
set @openmrsID :=212;
