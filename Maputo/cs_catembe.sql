...
mysql -uroot  -ppassword  <  fill_hdd/fill_hhd_catembe.sql
...
SELECT location_id,NAME,address2,county_district,state_province,location_id FROM openmrs.location where name  like '%atembe%';
*/
...
-- set @sismaLocationID := 1110609;  -- cs_catembe
-- set @openmrsID :=212;
