...
select * from openmrs.obs where encounter_id= 334108 order by concept_id ;



 delete from openmrs.obs where obs_id in (4113898);
 delete from openmrs.obs where obs_id in (3315891,3315892);
 delete from openmrs.obs where obs_id in (3315224,3315196);
